...
<div class="row" id="test">
	<div class="col-md-4 col-md-offset-4" style="padding-top:30px;">
		<h4 align="center" style="color:#fff;">Login Siswa</h4>
		<form method="post">
		  <div class="form-group" >
		    <label style="color:#fff;">No Induk Siswa</label>
		  ...
		  <center>
		  	<button type="submit" name="siswa" class="btn btn-success">Masuk</button>
		  </center>
		</form>
	</div>
</div>